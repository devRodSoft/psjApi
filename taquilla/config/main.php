    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'GET boletos/validar/<id:[\-A-Z0-9]+\d+>' => 'general/boletos/validar',
                'OPTIONS boletos/validar/<id:[\-A-Z0-9]+\d+>' => 'general/boletos/options',
                ...
                //find by hash
                'GET boletos/hash/<hash:[\-A-Z0-9]+\d+>' => 'general/boletos/hash',
                'OPTIONS boletos/hash/<hash:[\-A-Z0-9]+\d+>' => 'general/boletos/options',
